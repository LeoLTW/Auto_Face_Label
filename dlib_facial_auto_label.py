...
def labelFacial(img):
    ...
    if(len(rects)>0):
        ...
        for faceid, rect in enumerate(rects):
            ...
            if(ii>0):
                BBOX_facials = { "face": BBOX_faces, "lefteyebrow": BBOX_leftEyebrow, "righteyebrow": BBOX_rightEyebrow,                    "lefteye":BBOX_leftEye, "righteye":BBOX_rightEye, "nose":BBOX_nose,                    "outter_mouth": BBOX_outer_mouth, "inner_mouth": BBOX_inner_mouth, "chin":BBOX_chin }
...
if(mediaType=="video" or mediaType=="webcamera"):
    if(mediaType=="video"):
